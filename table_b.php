...
<?php
	...
	*/
	...
	//SQL sentence
	$stmt = $mysql->prepare("SELECT id, user_name, mail, gender, phone, Changed FROM my_Data WHERE deleted IS NULL ORDER BY Changed DESC LIMIT 10");
	...
	$stmt->bind_result($id, $user_name, $mail, $gender, $phone, $Changed);
	...
	$table_html .= "<table class='table table-hover'>";
		$table_html .= "<tr>";
			$table_html .= "<th>ID</th>";
			$table_html .= "<th>user_name</th>";
			$table_html .= "<th>mail</th>";
			$table_html .= "<th>gender</th>";
	        $table_html .= "<th>phone</th>";
            $table_html .= "<th>Changed</th>";
	...
	while($stmt->fetch()){
        ...
        $table_html .= "<td>".$id."</td>"; //add columns
			$table_html .= "<td>".$user_name."</td>"; //add columns
			$table_html .= "<td>".$mail."</td>";
			$table_html .= "<td>".$gender."</td>";
        	$table_html .= "<td>".$phone."</td>";
			$table_html .= "<td>".$Changed."</td>";
			$table_html .= "<td>
